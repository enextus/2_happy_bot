...
#            Character.create(name: 'Luke', movie: movies.first)
 message = {
            ...
            'thanks_msg' => 'Спасибо за твой ответ! До следующего сеанса, ',
            'warning_msg' => ', спасибо! Но твой ответ уже принят, до следующего сеанса!',
            'bye_msg' => 'До следующего сеанса, ',
            'req_msg' => ', пожалуйста, оцени следующее утверждение: * В данный момент я счастлив. *, сделав соответствующий выбор, нажатием кнопки ниже.'
}
